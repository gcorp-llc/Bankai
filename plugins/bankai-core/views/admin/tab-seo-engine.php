<!-- Tab: Autonomous SEO & Schema Architecture -->
<div id="tab-seo-engine" class="bankai-tab-pane" x-show="activeTab === 'seo-engine'" x-cloak>
    ...
    <div class="bankai-card" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding: 20px; flex-wrap: wrap; gap: 14px;">
        ...
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            <button type="button" @click="runSeoAudit()"
            ...
            <button type="button" @click="openSeoWizard()"
                ...
                <div class="bankai-card bankai-card-interactive" style="padding: 20px; display: flex; flex-direction: column; justify-content: space-between;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <div style="width: 36px; height: 36px; border-radius: 8px; background: rgba(9, 105, 218, 0.12); display: flex; align-items: center; justify-content: center; color: #0969DA; flex-shrink: 0;">
                                    <?php
                                    $icon_map = [
                                        'ai_search_visibility' => '<rect x="4" y="4" width="16" height="16" rx="4" /><path d="M9 9h.01M15 9h.01M9 15h6M12 2v2m0 16v2" />',
                                        'ai_meta_assistant'    => '<path d="M12 2v3m0 14v3M2 12h3m14 0h3M4.93 4.93l2.12 2.12m9.9 9.9l2.12 2.12" /><circle cx="12" cy="12" r="3" />',
                                        'ai_link_genius'       => '<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />',
                                        'instant_indexing'     => '<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />',
                                        'xml_sitemaps'         => '<polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6" /><line x1="8" y1="2" x2="8" y2="18" /><line x1="16" y1="6" x2="16" y2="22" />',
                                        'schema_builder'       => '<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" /><polyline points="3.27 6.96 12 12.01 20.73 6.96" /><line x1="12" y1="22.08" x2="12" y2="12" />',
                                        'monitor_404'          => '<path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" />',
                                        'image_seo'            => '<rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" />',
                                        'acf_integration'      => '<line x1="16.5" y1="9.4" x2="7.5" y2="4.21" /><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" />',
                                        'woocommerce_seo'      => '<circle cx="9" cy="21" r="1" /><circle cx="20" cy="21" r="1" /><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" />',
                                        'local_seo'            => '<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" />',
                                    ];
                                    $paths = $icon_map[$mod['id'] ?? ''] ?? '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" />';
                                    ?>
                    ...
                    <div style="border-top: 1px solid #D0D7DE; padding-top: 12px; display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-size: 11px; font-weight: 700;"
                              ...
                              x-text="seoState['<?php echo $mod_id; ?>'] ? t('active') : t('disabled')">Active</span>
                        <button type="button"
                                @click="openSeoDrawer('<?php echo $mod_id; ?>', isRtl ? '<?php echo $title_fa; ?>' : '<?php echo $title_en; ?>')"
    ...
    <!-- SEO Drawer -->
    <div x-show="seoDrawer.show" x-cloak class="bankai-modal-overlay" x-transition.opacity>
        <div @click.away="seoDrawer.show = false"
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid #D0D7DE; padding-bottom: 16px;">
                ...
                <button type="button" @click="seoDrawer.show = false" style="background: none; border: none; color: #8C959F; font-size: 20px; cursor: pointer;">&times;</button>
            </div>
            ...
            <div style="margin-bottom: 24px; display: flex; flex-direction: column; gap: 16px;">
                <div>
                    <label style="display: block; font-size: 12px; font-weight: 700; color: #656D76; margin-bottom: 6px;"
                           x-text="isRtl ? 'منطقه جغرافیایی و کشور هدف' : 'Primary Targeting Country / Region'">Primary Targeting Country / Region</label>
                ...
                <div>
                    <label style="display: block; font-size: 12px; font-weight: 700; color: #656D76; margin-bottom: 6px;"
                           x-text="isRtl ? 'شدت بهینه‌سازی خودکار' : 'Auto-Optimization Intensity'">Auto-Optimization Intensity</label>
                    <div style="display: flex; gap: 12px;">
                        <button type="button" style="flex: 1; background-color: rgba(31, 136, 61, 0.15); border: 1px solid #1A7F37; color: #1A7F37; padding: 10px; border-radius: 8px; font-size: 12px; font-weight: 700; cursor: pointer;"
                                x-text="isRtl ? 'حالت امن (پیشنهادی)' : 'Safe Mode (Recommended)'">Safe Mode</button>
                        <button type="button" style="flex: 1; background-color: #FFFFFF; border: 1px solid #D0D7DE; color: #656D76; padding: 10px; border-radius: 8px; font-size: 12px; font-weight: 600; cursor: pointer;"
                                x-text="isRtl ? 'رتبه‌بندی تهاجمی' : 'Aggressive Ranker'">Aggressive Ranker</button>
                    </div>
                </div>
            </div>

            <div style="display: flex; justify-content: flex-end; gap: 12px;">
                <button type="button" @click="seoDrawer.show = false"
                ...
                <button type="button" @click="saveSeoDrawerSettings()"
                        ...
                        x-text="isRtl ? 'ذخیره تنظیمات ماژول' : 'Save Module Configuration'">Save Module Configuration</button>
            </div>
        </div>
    </div>
</div>