<!-- Bankai Admin Top Navigation Header - GitHub Light Edition -->
<header id="bankai-admin-header"
    ...
    <div style="display: flex; align-items: center; gap: 12px;">
        ...
        <button id="btn-mobile-menu"
                ...
                :title="isRtl ? 'باز و بسته کردن منو' : 'Toggle navigation menu'"
        ...
        <div style="width: 32px; height: 32px; border-radius: 8px; overflow: hidden; border: 1px solid #D0D7DE; background-color: #F6F8FA; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 1px 2px rgba(31, 35, 40, 0.04);">
            <img src="/logo.jpg" alt="Bankai Logo" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 40 40\'%3E%3Crect width=\'40\' height=\'40\' fill=\'%230969DA\'/%3E%3Ctext x=\'20\' y=\'26\' font-size=\'20\' font-weight=\'bold\' fill=\'%23FFFFFF\' text-anchor=\'middle\'%3EB%3C/text%3E%3C/svg%3E';">
        </div>
    ...
    <div class="bankai-header-actions" style="display: flex; align-items: center; gap: 10px;">
        <!-- Purge Cache Quick Action -->
        <button id="btn-purge-cache"
                @click="purgeAllCaches()"
                :title="isRtl ? 'تخلیه تمام کش‌های صفحه و سرور' : 'Purge All Caches'"
            ...
            <span x-text="t('purgeCache')">Purge Cache</span>
        </button>

        <!-- Language Toggle -->
        <button id="btn-toggle-lang"
                @click="toggleLanguage()"
                :title="isRtl ? 'تغییر به زبان انگلیسی' : 'Switch to Persian (RTL)'"
                class="bankai-btn bankai-btn-default"
