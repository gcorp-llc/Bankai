<!-- Tab 7: Settings & License Management - GitHub Light Edition -->
<div id="tab-settings-license" x-show="activeTab === 'settings'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
    <!-- View Header & Actions -->
    <div class="bankai-card" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; padding: 20px; flex-wrap: wrap; gap: 14px;">
        ...
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            <button @click="triggerSaveLoader({ title: isRtl ? 'در حال ذخیره‌سازی تمامی تنظیمات پلتفرم...' : 'Saving All Platform Settings...', message: isRtl ? 'در حال اعمال پرچم‌های ماژولار، سطوح دسترسی و هماهنگ‌سازی دیتابیس...' : 'Updating modular flags, role permissions and synchronizing database...', duration: 700 })"
                    id="btn-save-all-settings"
                    style="background-color: #0969DA; border: 1px solid #0969DA; color: #FFFFFF; padding: 10px 18px; border-radius: 8px; font-size: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s; box-shadow: 0 1px 3px rgba(9, 105, 218, 0.3);">
                <!-- Solar Broken Save / Disk -->
                <svg class="solar-icon solar-icon-sm" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <button @click="confirmFactoryReset()"
                    style="background-color: rgba(207, 34, 46, 0.12); border: 1px solid rgba(207, 34, 46, 0.4); color: #CF222E; padding: 10px 18px; border-radius: 8px; font-size: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s;">
                <!-- Solar Broken Danger Triangle -->
    ...
    <div class="bankai-card" style="padding: 24px; margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap;">
            <div style="width: 50px; height: 50px; border-radius: 12px; background-color: rgba(9, 105, 218, 0.12); border: 1px solid rgba(9, 105, 218, 0.3); display: flex; align-items: center; justify-content: center; color: #0969DA;">
                <!-- Solar Broken Award / Medal -->
                <svg class="solar-icon solar-icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Modular Global Switcher Matrix -->
    <div class="bankai-card" style="padding: 24px; margin-bottom: 24px;">
        <h3 style="font-size: 15px; font-weight: 700; color: #1F2328; margin: 0 0 16px 0; display: flex; align-items: center; gap: 8px;">
            ...
            <span x-text="isRtl ? 'کلیدهای سراسری مدیریت ماژول‌ها و سرویس‌ها' : 'Modular Global Architecture Switcher'">Modular Global Architecture Switcher</span>
        </h3>
        ...
        <div class="bankai-grid-2">
            <div style="background-color: #F6F8FA; border: 1px solid #D0D7DE; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <div style="font-size: 11px; color: #8C959F;" x-text="isRtl ? 'سوئیچ اصلی برای اسکیما، متادیتا و پایش خطاهای ۴۰۴' : 'Master toggle for all SEO, Schema, and 404 monitoring'">Master toggle for all SEO, Schema, and 404 monitoring</div>
                </div>
            ...
            <div style="background-color: #F6F8FA; border: 1px solid #D0D7DE; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <div style="font-size: 11px; color: #8C959F;" x-text="isRtl ? 'سوئیچ اصلی برای کش صفحات، فشرده‌سازی و ردیس' : 'Master toggle for page cache, minification & Redis daemon'">Master toggle for page cache, minification &amp; Redis daemon</div>
                </div>
                <label class="bankai-switch">
            ...
            <div style="background-color: #F6F8FA; border: 1px solid #D0D7DE; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <div style="font-weight: 700; font-size: 13px; color: #1F2328;" x-text="isRtl ? 'استودیو بهینه‌سازی رسانه و واترمارک' : 'Media & Dynamic Watermark Studio'">Media &amp; Dynamic Watermark Studio</div>
                    <div style="font-size: 11px; color: #8C959F;" x-text="isRtl ? 'سوئیچ اصلی برای تبدیل وب‌پی/آویف و واترمارک هوشمند' : 'Master toggle for WebP/AVIF and automated watermarks'">Master toggle for WebP/AVIF and automated watermarks</div>
                </div>
                <label class="bankai-switch">
            ...
            <div style="background-color: #F6F8FA; border: 1px solid #D0D7DE; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <div style="font-size: 11px; color: #8C959F;" x-text="isRtl ? 'سوئیچ اصلی برای جمینای، اوپن‌ای‌آی و کلود' : 'Master toggle for Gemini, OpenAI, Claude & DeepSeek APIs'">Master toggle for Gemini, OpenAI, Claude &amp; DeepSeek APIs</div>
                </div>
                <label class="bankai-switch">
            ...
            <div style="background-color: #F6F8FA; border: 1px solid #D0D7DE; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <div style="font-weight: 700; font-size: 13px; color: #1F2328;" x-text="isRtl ? 'استاندارد llms.txt و API مانیفست هوش مصنوعی' : 'Standard llms.txt & Manifest API'">Standard llms.txt &amp; Manifest API</div>
                    <div style="font-size: 11px; color: #8C959F;" x-text="isRtl ? 'فعال‌سازی مسیرهای /llms.txt برای ربات‌های جستجوی مبتنی بر هوش مصنوعی' : 'Enables /llms.txt and /llms-full.txt endpoints for crawler agents'">Enables /llms.txt and /llms-full.txt endpoints for crawler agents</div>
                </div>
                <label class="bankai-switch">
                    <input type="checkbox" checked @change="triggerSaveLoader({ title: isRtl ? 'در حال به‌روزرسانی اندپوینت llms.txt...' : 'Updating llms.txt Configuration...', savedTitle: isRtl ? 'تنظیمات llms.txt ذخیره شد' : 'llms.txt Config Saved' })">
                    <span class="bankai-slider"></span>
                </label>
            </div>
            ...
            <div style="background-color: #F6F8FA; border: 1px solid #D0D7DE; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <div style="font-weight: 700; font-size: 13px; color: #1F2328;" x-text="isRtl ? 'ایندکس آنی (گوگل و IndexNow)' : 'Instant Indexing API (Google & IndexNow)'">Instant Indexing API (Google &amp; IndexNow)</div>
                    <div style="font-size: 11px; color: #8C959F;" x-text="isRtl ? 'اطلاع‌رسانی بلادرنگ به موتورهای جستجو بلافاصله پس از انتشار محتوا' : 'Pings search engines instantly upon post publishing'">Pings search engines instantly upon post publishing</div>
                </div>
                <label class="bankai-switch">
    ...
    <!-- RBAC & Configuration Portability Grid -->
    <div class="bankai-grid-split" style="margin-bottom: 24px;">
        <!-- Role-Based Access Control -->
        <div class="bankai-card" style="padding: 24px;">
            <h3 style="font-size: 15px; font-weight: 700; color: #1F2328; margin: 0 0 16px 0; display: flex; align-items: center; gap: 8px;">
                <!-- Solar Broken Users Group -->
                <svg class="solar-icon" style="color: #0969DA;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                    <circle cx="9" cy="7" r="4" />
                    <path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />
                </svg>
                <span x-text="isRtl ? 'سطوح دسترسی نقش‌های کاربری وردپرس' : 'Role-Based Access Permissions'">Role-Based Access Permissions</span>
            </h3>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <div style="display: flex; justify-content: space-between; align-items: center; background-color: #F6F8FA; padding: 10px 14px; border-radius: 8px; border: 1px solid #D0D7DE;">
                    <span style="font-size: 12px; color: #1F2328; font-weight: 600;" x-text="isRtl ? 'مدیران کل (دسترسی کامل و تام)' : 'Administrators (Full Access)'">Administrators (Full Access)</span>
                    <span style="color: #1A7F37; font-weight: 700; font-size: 11px;" x-text="isRtl ? 'اجباری و فعال' : 'Enforced'">Enforced</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center; background-color: #F6F8FA; padding: 10px 14px; border-radius: 8px; border: 1px solid #D0D7DE;">
                    <span style="font-size: 12px; color: #1F2328; font-weight: 600;" x-text="isRtl ? 'ویرایشگران (ابزارهای سئو و هوش مصنوعی محتوا)' : 'Editors (SEO & Content AI Tools)'">Editors (SEO &amp; Content AI Tools)</span>
                    <label class="bankai-switch">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; background-color: #F6F8FA; padding: 10px 14px; border-radius: 8px; border: 1px solid #D0D7DE;">
                    <span style="font-size: 12px; color: #1F2328; font-weight: 600;" x-text="isRtl ? 'نویسندگان (فقط تولید طرح اولیه هوش مصنوعی)' : 'Authors (AI Outlines Only)'">Authors (AI Outlines Only)</span>
                    <label class="bankai-switch">
        ...
        <div class="bankai-card" style="padding: 24px;">
            ...
            <p style="font-size: 12px; color: #656D76; line-height: 1.5; margin: 0 0 16px 0;"
               x-text="isRtl ? 'برون‌بری تمام تنظیمات فعال، مختصات واترمارک و الگوهای هوش مصنوعی به یک فایل استاندارد JSON برای انتقال سریع به سایت دیگر.' : 'Export all active settings, watermark coordinates, and prompt manifests to a single portable JSON file for instant staging-to-production deployments.'">
                Export all active settings, watermark coordinates, and prompt manifests to a single portable JSON file for instant staging-to-production deployments.
            </p>
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                ...
                <label style="flex: 1; min-width: 130px; text-align: center; background-color: #F6F8FA; border: 1px solid #D0D7DE; color: #1F2328; padding: 10px; border-radius: 8px; font-size: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 6px;"
                       x-text="isRtl ? 'درون‌ریزی فایل JSON' : 'Import JSON'">
                    Import JSON
    ...
    <div class="bankai-card" style="padding: 24px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; flex-wrap: wrap; gap: 10px;">
            <h3 style="font-size: 15px; font-weight: 700; color: #1F2328; margin: 0; display: flex; align-items: center; gap: 8px;">
                <!-- Solar Broken Clipboard / Document -->
                <svg class="solar-icon" style="color: #0969DA;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" />
                    <rect x="8" y="2" width="8" height="4" rx="1" ry="1" />
                </svg>
                <span x-text="isRtl ? 'گزارش عیب‌یابی و وضعیت سیستم وردپرس' : 'System Diagnostic Log Report'">System Diagnostic Log Report</span>
            </h3>
